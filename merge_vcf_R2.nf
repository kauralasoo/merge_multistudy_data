...
include { extract_samples_from_vcf; index_vcf; merge_vcf; filter_vcf_R2; update_format_R2 } from './modules/vcf_manupilations'
...
workflow {
  ...
  update_format_R2(update_format_ch)
  index_vcf(update_format_R2.out)
  merge_vcf(index_vcf.out[0].collect(), index_vcf.out[1].collect())
  filter_vcf_R2(merge_vcf.out)
